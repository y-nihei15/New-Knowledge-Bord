...
function statusClass(int $tinyInt)
{
  switch ($tinyInt) {
    case 1:
      return ['class' => 'blue',  'data' => 1]; // present
    case 2:
      return ['class' => 'red',   'data' => 2]; // absent
    case 3:
      return ['class' => 'green', 'data' => 3]; // leave
    default:
      return ['class' => 'red',  'data' => 2]; // 未設定→absent(2)
  }
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <script>
    ...
    function buildDiffItem(row) {
      ...
      // status（変更があれば送る）: '1'|'2'|'3' をそのままAPIへ
